...
<?php $comments->gravatar('48', ''); ?>
    ...
    <div id="comments" class="cf">
        ...
        <?php if ($comments->have()): ?>
            <span
                class="comment-num"><?php $this->commentsNum(_t('No comments'), _t('1 comment'), _t('%d comments')); ?></span>
                ...
                <div id="author_info" style="display:none;">
                    ...
                    <div id="author_info">
                        ...
                        <input type="text" name="author" maxlength="12" id="author" class="form-control"
                               placeholder="<?php _e('Name *'); ?>" value="<?php $this->remember('author'); ?>">
                        <input type="email" name="mail" id="mail" class="form-control"
                               placeholder="<?php _e('Email *'); ?>" value="<?php $this->remember('mail'); ?>">
